      ...
      <div className="px-4 md:px-8 py-32 max-w-[95vw] mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-[#A1A1AA] font-bold uppercase tracking-widest text-sm">
            <li><Link to="#" className="hover:text-[#DFE104] transition-colors">Features</Link></li>
            <li><Link to="#" className="hover:text-[#DFE104] transition-colors">Docs</Link></li>
            <li><Link to="#" className="hover:text-[#DFE104] transition-colors">API</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-xl font-bold uppercase tracking-tighter text-[#FAFAFA] mb-6">Connect</h4>
          <ul className="space-y-4 text-[#A1A1AA] font-bold uppercase tracking-widest text-sm">
            <li><Link to="#" className="hover:text-[#DFE104] transition-colors">GitHub</Link></li>
